...
public class ServerDriver 
{
    ...
    public static void main(String[] args)
    {
        ...
        */
        ...
        CreateAuto a2 = (CreateAuto)a1;
        a2.buildAuto("Ford_Focus_Wagon_ZTW.txt", false);
        a2.buildAuto("RollsRoyce.txt", false);
        
        BuildCarModelOptions t2 = new BuildCarModelOptions(a1);
